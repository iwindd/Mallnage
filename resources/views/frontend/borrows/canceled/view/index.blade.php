...
<nav aria-label="breadcrumb">
    <div class="container">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item"><a href="{{route('borrowsCanceled')}}" class="text-decoration-none">การเบิกที่ถูกยกเลิก</a></li>
            <li class="breadcrumb-item active" aria-current="page">การเบิกที่ถูกยกเลิก</li>
        </ol>
    </div>
</nav>
    ...
    <div class="container mt-3 py-2 ">
        ...
        <div class="row">
            ...
            <div class="col-md-6 ">
                <div class="card h-100">
                    <div class="card-header">รายละเอียดการยกเลิก</div>
                    <div class="card-body">
                        <div class="row">
                            <div class="row mb-2">
                                <div class="col-sm-4 col-form-label text-md-end" >
