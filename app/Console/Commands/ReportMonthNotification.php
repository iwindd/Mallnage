...
class ReportMonthNotification extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'cron:notification_month';
    ...
    private function GetProfitAndSold($id){
        ...
        ->whereBetween('logs.created_at', [$startMonth, $endMonth])
        ->leftJoin('products', [
    ...
    public function handle()
    {
        ...
        foreach($users as $user){
            ...
            $message = "(เดือน) รายงานผล วันที่ $currentDate \n";
